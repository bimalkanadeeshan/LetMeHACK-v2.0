...
public class LeaderBoard extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        View topToolbar = findViewById(R.id.top_toolbar_LeaderBoard); // root View id from that link
        ...
        ttB.setOnClickListener(new View.OnClickListener()
        {
            ...
            {
                Intent i = new Intent( LeaderBoard.this, SignupActivity.class);
                startActivity(i);
...
//                .load(photo);
            ...
            Glide.with(this).load(photo).asBitmap().centerCrop().into(new BitmapImageViewTarget(ionImage) {
                ...
                protected void setResource(Bitmap resource) {
                    RoundedBitmapDrawable circularBitmapDrawable =
                            RoundedBitmapDrawableFactory.create(LeaderBoard.this.getResources(), resource);
        ...
        btnAboutUs.setOnClickListener(new View.OnClickListener()
        {
            ...
            public void onClick(View v)
            {
                Intent i = new Intent( LeaderBoard.this, AboutUs.class);
                startActivity(i);
            }
        });
        ...
        btnContactUs.setOnClickListener(new View.OnClickListener()
        {
            ...
            public void onClick(View v)
            {
                Intent i = new Intent( LeaderBoard.this, ContactUs.class);
                startActivity(i);
            }
        });
        ...
        btnSponsor.setOnClickListener(new View.OnClickListener()
        {
            ...
            public void onClick(View v)
            {
                Intent i = new Intent( LeaderBoard.this, SponsoreActivity.class);
                startActivity(i);
            }
        });
        ...
        btnMap.setOnClickListener(new View.OnClickListener()
        {
            ...
            public void onClick(View v)
            {
                Intent i = new Intent( LeaderBoard.this, MapActivity.class);
                startActivity(i);
            }
        });
        ...
        btnLogout.setOnClickListener(new View.OnClickListener()
        {
            ...
            public void onClick(View v)
            {
                ...
                Toast.makeText(LeaderBoard.this,"logout successfull",Toast.LENGTH_SHORT).show();
        ...
        View bottomToolbar = findViewById( R.id.bottom_toolbar_LeaderBoard ); // root View id from that link
        TextView tv = topToolbar.findViewById(R.id.textView);
        tv.setText("Leader Board");
        Button ib = bottomToolbar.findViewById(R.id.btnLeaderBoard);
        ib.setBackgroundResource(R.mipmap.leaderboard_selected);
        ...
        btnage.setOnClickListener(new View.OnClickListener()
        {
            ...
            public void onClick(View v)
            {
                Intent i = new Intent( LeaderBoard.this, AgendaActivity.class);
                startActivity(i);
                finish();
            }
        });
        ...
        btnhome.setOnClickListener(new View.OnClickListener()
        {
            ...
            public void onClick(View v)
            {
                Intent i = new Intent( LeaderBoard.this, HomeActivity.class);
                startActivity(i);
                finish();
            }
        });
        ...
        btnQR.setOnClickListener(new View.OnClickListener()
        {
            ...
            public void onClick(View v)
            {
                Intent i = new Intent( LeaderBoard.this, QRActivity.class);
                startActivity(i);
                finish();
            }
        });
        ...
        btnLeaderBoard.setOnClickListener(new View.OnClickListener()
        {
            ...
            public void onClick(View v)
            {
                Intent i = new Intent( LeaderBoard.this, LeaderBoard.class);
                startActivity(i);
                finish();
            }
        });
        ...
        btnFaq.setOnClickListener(new View.OnClickListener()
        {
            ...
            public void onClick(View v)
            {
                Intent i = new Intent( LeaderBoard.this, FAQActivity.class);
                startActivity(i);
                finish();
            }
        });
    ...
    public void loadWeb(){
        ...
        WebView webView= findViewById(R.id.webview);//Load web Site)
        ...
        webView.loadUrl("https://letmehack.lk/letmeapp/api/stats");
        ...
        webView.setWebViewClient(new WebViewClient(){
            public void onPageFinished(WebView view,String url){
               //hide the swipe refresh layout
                ...
                //Toast.makeText(LeaderBoard.this,"Page Loaded",Toast.LENGTH_SHORT).show();
            }
        });
        //Toast.makeText(LeaderBoard.this,"Page Started Loading",Toast.LENGTH_SHORT).show();
    }
